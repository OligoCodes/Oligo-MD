...
const ownerNumber = ['233591179690']
...
console.log("CONNECTING Oligo-MD 🧬...");
...
console.log('Oligo-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *꧁✨Oligo-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Joseph Bonsu ✅*
...
if(senderNumber.includes("233591179690")){
if(isReact) return
m.react("🦋")
   }

if(senderNumber.includes("23359117960")){
if(isReact) return
m.react("🎀")
   }
