...
async (conn,mek, m, { from, body, isGroup, isAdmins, isBotAdmins, reply, sender }) => {
    try {
        ...
        const badWords = [
  "wtf", "w.t.f", "what the fuck", "fuck", "f*ck", "f**k", "f***", 
  "shit", "sh*t", "sh**", 
  "bitch", "bi*ch", "b*tch", 
  "asshole", "a**hole", "a**", "ass", 
  "sex", "s3x", "xxx", "x x x", 
  "porn", "p*rn", "p0rn", 
  "huththa", "hutto", "pakaya", "ponnaya", 
  "mia", "dick", "cock", "pussy", "boobs", 
  "slut", "hoe", "whore", "faggot", "gay"  // Optional: Include only if needed contextually
];
